...
def init_browser():
    ...
    try:
        ...
        printyellow("Browser initialization failed. Ensure ChromeDriver is installed and compatible.")
        printyellow("Refer to the browser setup guide: https://github.com/feder-cr/LinkedIn_AIHawk_automatic_job_application/blob/main/readme.md#browser-setup")
...
def main(resume: Path = None, premade_resume: Path = None):
