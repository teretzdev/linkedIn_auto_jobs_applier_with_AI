...
def main(resume: Path = None, premade_resume: Path = None):
    ...
    try:
        ...
        premade_resume_path = parameters.get('premadeResumePath', None)
        ...
        # Use premade_resume_path as default if no command-line argument is provided
        parameters['uploads'] = FileManager.file_paths_to_dict(premade_resume or resume or Path(premade_resume_path), plain_text_resume_file)
